...
const settings = {
	"async": true,
	"crossDomain": true,
	"url": "https://bing-entity-search.p.rapidapi.com/entities?q="+myParam+"%20City&mkt=en-in",
	"method": "GET",
	"headers": {
		"x-bingapis-sdk": "true",
...
if ( myParam.length <= 1) {
	$('.detailsSearch').html(error_message);
}
else{
